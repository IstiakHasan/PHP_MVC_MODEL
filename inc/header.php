...
.headeroption h2 {color: #000;font-size: 30px;padding-top: 5px;text-shadow: 0 1px 1px #fff;margin-left: 35px;}
...
.footerone{background:#3aa0ff;border-radius:5px;float:left;font-size:18px;line-height:23px;margin-left:10px;
padding:6px 10px;text-align:center;text-shadow:1px 0 2px #fff;width:390px;overflow:hidden;}
...
<body>
    <header class="headeroption">
        <h2>Insert ,Edit and Remove Data</h2>
    </header>
    <div class="content">
